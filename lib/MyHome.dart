...
import 'package:book_juk/models/BookModel.dart';
import 'package:book_juk/CustomNavigator.dart';
...
class _BookState extends State<Book> {
  ...
  Widget build(BuildContext context) {
    ...
    final bookTitle = "${widget.book.book.title.substring(
        0, (widget.book.book.title.length > 10) ? 10 : widget.book.book.title.length
      )}${(widget.book.book.title.length > 10) ? "..." : ""}";
    ...
    return GestureDetector(
      onTap: () {
        showDialog (context: context,
            builder: (context) {
          return AlertDialog(
            title: Text(widget.book.book.title),
            content: Text(widget.book.book.description ?? '설명 없음'),
            actions: [
